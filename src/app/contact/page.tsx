...
export default function ContactPage() {
  return (
    <div className="w-3/4 pl-20 flex flex-col h-full items-start justify-center text-white text-sm">
      ...
      <p>Feel free to reach me by email at <Link href="mailto:victorlemercier.dev@gmail.com" target="_blank" className="underline">victorlemercier.dev@gmail.com</Link> <br />
      Here’s my <Link href="https://www.linkedin.com/in/victorlemercier/" target="_blank" className="underline">LinkedIn</Link></p>
