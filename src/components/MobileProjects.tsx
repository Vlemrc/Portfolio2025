          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              >
                ...
                <h2
                  style={{ color: data[currentIndex].color }}
                  className={`font-arges uppercase font-bold text-white transition-all duration-700 ease-in-out text-[80px] absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-[70%] text-2xl z-20 w-full text-center ${videoActive ? "opacity-0" : "opacity-100"}`}
                >
              ...
              {activeProject && activeProject.github && isExpanded && (
                <Link href={activeProject?.github} target="_blank" className="mt-8">
