...
export default function Resume() {
    ...
    return (
        <div className="overflow-hidden">
            <Link href="/CV2025VictorLemercier.pdf" target="_blank" className={`flex flex-row items-end gap-1 group transition-all duration-300 ${showTitle ? 'translate-y-0' : '-translate-y-6'}`}>
                <p className="text-white text-[10px] uppercase font-bold">Download my resume</p>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-[10px] h-[8px] -translate-y-[3px] transition-all duration-300 group-hover:rotate-45 rotate-90" viewBox="0 0 233.23 251.64">
