...
export default function Resume() {
    ...
    return (
        <div className="overflow-hidden">
            <Link href="/2026VictorLemercier.pdf" target="_blank" className={`flex flex-row items-end gap-1 group transition-all duration-300 ${showTitle ? 'translate-y-0' : '-translate-y-6'}`}>
